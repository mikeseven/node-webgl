...
module.exports = function () {
    ...
    platform = {
        ...
        createWindow: function (width, height) {
            ...
            // width and height args sent to GLFW.CreateWindow must be > 0
            width = width || 800;
            height = height || 800;

            // for fullscreen, hardcode monitor idx to first monitor.
            window = fullscreen ? GLFW.CreateWindow(width, height,"WebGL", 0) : GLFW.CreateWindow(width, height,"WebGL");
